...
func (ik InterNftKeeperWrapper) CreateOrUpdateClass(ctx sdk.Context,
	...
	// TODO: Potentially build the class data from the classData string
	// see https://github.com/irisnet/irismod/blob/ed68a47b55d7990edf7962372af1221f88b8d6e4/modules/nft/types/builder.go#L102
	// and: https://github.com/UptickNetwork/uptick/blob/a67f8c973f0b4068493b5063a3f99fa8816558cf/x/internft/keeper.go#L49 (might be a copy from iris)
	// This might be more important when we need to transfer nfts from cosmos to ethereum
	class := nft.Class{
		Id:  classID,
		Uri: classURI,
	}
...
func (ik InterNftKeeperWrapper) Mint(ctx sdk.Context, classID, tokenID, tokenURI string, tokenData string, receiver sdk.AccAddress) error {
	// TODO: Potentially build the nft from the tokenData (again, see irismod for example, linked higher up)
	token := nft.NFT{
		ClassId: classID,
		Id:      tokenID,
		Uri:     tokenURI,
...
func (ik InterNftKeeperWrapper) Transfer(ctx sdk.Context, classID string, tokenID string, tokenData string, receiver sdk.AccAddress) error {
	// TODO: Potentially update the nft from the tokenData (again, see irismod for example, linked higher up)
...
func (ik InterNftKeeperWrapper) GetClass(ctx sdk.Context, classID string) (ibcnfttransfertypes.Class, bool) {
	// TODO: Potentially build the class from the class (again, see irismod for example, linked higher up)
