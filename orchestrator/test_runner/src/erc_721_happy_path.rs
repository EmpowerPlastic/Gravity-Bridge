...
use ethereum_gravitynft::send_erc721_to_cosmos::send_erc721_to_cosmos;
use ethereum_gravitynft::utils::get_gravity_sol_address;
use ethereum_gravitynft::utils::get_valset_nonce;
use cosmos_gravitynft::query::get_erc721_attestations;
use gravity_proto::cosmos_sdk_proto::cosmos::nft::v1beta1::QueryNfTsRequest;
use gravity_proto::cosmos_sdk_proto::cosmos::nft::v1beta1::query_client::QueryClient as NftQueryClient;
use gravity_proto::gravitynft::query_client::QueryClient as GravityQueryClient;
use gravity_proto::gravitynft::MsgSendNftToCosmosClaim;
...
async fn check_send_erc721_to_cosmos_attestation(
    ...
    let mut found = false;
    loop {
        iterate_attestations(grpc_client, &mut |decoded: MsgSendNftToCosmosClaim| {
